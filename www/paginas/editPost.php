            ...
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto ">
                    <div class="brand text-center capa">
                        <h1><input type="text" name="titulo" class="titInp" id="titInp" onblur="resuRefil(this)" value="<?php echo $dados['titulo']; ?>"></h1>
        ...
        <div class="section section-TextoPost">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <p>
                            <textarea name="resumo" class="textAreaNovoPost" onkeydown="resizeTextArea(this)" onblur="resuRefil(this)"><?php echo $dados['resumo']; ?></textarea>
                        </p>
                        <p>
                            <textarea name="descricao" class="textAreaNovoPost" onkeydown="resizeTextArea(this)" onblur="resuRefil(this)"><?php echo $dados['descricao']; ?></textarea>
                        </p>
                    </div>
                </div>
                <div class="endNovoPostSubmit">
                   <input class="btn btn-primary btn-round" type="submit" onclick="salvarMetoArea()" value="Salvar">
                </div>
            </div>
