        ...
        <div class="container">
            <div class="row row-login row-cadastro">
                ...
                <div class="col-lg-6 login-campos cadastro-campos">
                	<form method="post" accept-charset="utf-8" id="formao">
            			<h3>Cadastrar</h3>
                            ...
                            <div class="col-6">
                                <div>
                                    <label class="check" id="lbl-termoDeUso" onclick="myChecked_termoDeUso('lbl-termoDeUso', 'chk-termoDeUso')">
                                        ...
                                        <input class="" id="chk-termoDeUso" type="checkbox" id="chk" value=""> Aceito os <a href="docs/termo_de_uso.pdf">termos de uso</a>
                                    </label>
                                </div>
                            </div>
                            <div class="col-6">
    ...
    <div class="Message col-8 d-inline-flex flex-wrap is-hidden" id="js-timer">
        <div class=" Message-icon ">
            <i class="fas " id="icon-message"></i>
        </div>
